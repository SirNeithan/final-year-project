...
<div class="page-container">
    <div class="page-header">
        ...
        <p class="page-description">
            Start your meal with our delicious selection of appetizers. From classic favorites to innovative creations, 
            each dish is crafted to awaken your taste buds.
        </p>
    </div>

    <?php if (empty($results)): ?>
        <div class="empty-state">
            <div class="empty-state-icon"><i class="ri-leaf-line" style="font-size:3rem;color:#ccc;"></i></div>
            <h2 class="empty-state-title">No Appetizers Found</h2>
            <p class="empty-state-description">
                We couldn't find any appetizers<?php echo $restaurant ? ' from ' . htmlspecialchars($restaurant) : ''; ?>. 
